...
/*   Updated: 2023/09/05 22:26:06 by yloutfi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update(t_event evt, t_mlx *mlx)
{
	...
	tmp_x = mlx->player->x + evt.is_moving * (cos(mlx->player->angle) * 1);
	tmp_y = mlx->player->y + evt.is_moving * (sin(mlx->player->angle) * 1);
